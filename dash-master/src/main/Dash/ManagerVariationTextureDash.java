...
public class ManagerVariationTextureDash implements SpriteManager{
	...
	public ManagerVariationTextureDash(DrawableImage image, int renderingSize,int nbSpriteCol,int nbSpriteLine) {
